...
def get_parameters():
    ...
    parser.add_argument('--dataset', type=str, default='cartoon', choices=['lsun', 'celeb'])
    parser.add_argument('--use_tensorboard', type=str2bool, default=False)

    # Path
    parser.add_argument('--image_path', type=str, default='/home/xinzi/dataset/cartoonset10k')
    parser.add_argument('--test_data_path', type=str,default='/home/xinzi/dataset/cartoonset_test')
